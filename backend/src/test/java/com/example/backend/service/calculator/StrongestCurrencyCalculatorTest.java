...
@DisplayName("StrongestCurrencyCalculator Tests")
class StrongestCurrencyCalculatorTest {

    private final StrongestCurrencyCalculator calculator = new StrongestCurrencyCalculator();

    @Nested
    @DisplayName("Black-Box Tests - Peak Identification")
    class BlackBoxTests {

        @Test
        void calculate_CorrectStrongestCurrency() {
            ...
            assertEquals("CZK", results.getStrongestCurrency());
        }
    }
    ...
    class WhiteBoxTests {
        ...
        void calculate_HandlesNullQuotes() {
            ...
            assertNull(results.getStrongestCurrency());
        }
        ...
        void calculate_HandlesMissingWatchedCurrencies() {
            ExchangeRateResponse data = new ExchangeRateResponse();
            data.setSource("EUR");
            data.setQuotes(Map.of("EURGBP", 0.8)); // Missing USD
        ...
        void calculate_HandlesAllCurrenciesMissingInData() {
            ExchangeRateResponse data = new ExchangeRateResponse();
            data.setSource("EUR");
            data.setQuotes(Map.of("EURABC", 123.0));
